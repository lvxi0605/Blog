...
jQuery.fn.searchFilter = function(fields, options) {
    ...
    function SearchFilter(jQ, fields, options) {
        ...
        if (fields != null) { // type coercion matches undefined as well as null
            ...
            // setup the field select with an on-change listener if there are custom ops or data
            ...
            // go ahead and call the change listener and setup the ops and data values
